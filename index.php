...
if(mysqli_connect_error()){
	...
	if(isset($_POST['btns'])){
		...
		$_SESSION['user'] = $_POST['unames'];
		//echo $_SESSION['user'];
		$unames = mysqli_real_escape_string($con,$_POST['unames']);
	$upasses = mysqli_real_escape_string($con,$_POST['upasses']);
	$queryy = "SELECT * FROM `register`";
	$result = mysqli_query($con,$queryy);
	
	while($row = mysqli_fetch_assoc($result)){
		
		if($row['username']==$unames and $row['password']==$upasses){
				...
				<ul>
					...
					<li>
						<a href="#" data-toggle="modal" data-target="#myModal1">
							<span class="fa fa-truck" aria-hidden="true"></span>Not Signed In</a>
					</li>
					<li>
...
<input type="text" name="unames" placeholder="Username">

							</div>
							<div class="styled-input">
<input type="password" name="upasses" placeholder="Password">
...
if(isset($_POST['btn'])and $_POST['username']!="" and $_POST['pass']!==""){
	...
	while($row = mysqli_fetch_assoc($result)){
		...
		if($row['username']==$uname){
			...
			$msgs = "<br>This username is already been taken<br>";
			$val = "0";
			break;
	...
	if($val=="1"){
			...
			$msgs = "<br>Fill Details<br>";
			if(mysqli_query($con,"INSERT INTO `register` (username,password) VALUES('".$uname."','".$upass."')")){
			...
			else if($uname=="" or $upass=="") {
				
				echo "<br>Fill Correct Details";
...
<input type="submit" name="btn" placeholder="xx">
					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav menu__list">
								...
								<li class="">
									<a class="nav-stylehead" href="contact.php">Products</a>
								</li>
